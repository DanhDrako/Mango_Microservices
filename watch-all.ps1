...
Start-Process "dotnet" "watch --project Mango.Services.PaymentAPI\Mango.Services.PaymentAPI.csproj"
Start-Process "dotnet" "watch --project Mango.Services.RewardAPI\Mango.Services.RewardAPI.csproj"